        ...
        <div className="space-y-10">
          <section>
            ...
            <p className="text-[#5A4E42] text-sm leading-relaxed">
              Any day you log at least one practice session, whether
              timed or manual, counts. It doesn&apos;t matter if
              it&apos;s five minutes or five hours, the point is showing
              up. Your streak number shows on the Practice tab, right
              under Mewstro.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-[#5A4E42] text-sm leading-relaxed">
              Open the Calendar tab and you&apos;ll see your last 90 days
              as a grid. Each day you practised is filled in green, and
              the more you practised the darker the square gets. Days you
              missed stay empty. It&apos;s a quick visual scan of how
          ...
          <section>
            ...
            <p className="text-[#5A4E42] text-sm leading-relaxed">
              Below the heatmap you&apos;ll see three rings, for daily,
              weekly, and monthly practice. These fill up as you hit
              your practice goals. You set your daily goal during
              onboarding, and can change it any time in Settings &gt;
              Goals. The weekly and monthly rings are calculated from
              your daily target.
            </p>
          ...
          <section>
            ...
            <p className="text-[#5A4E42] text-sm leading-relaxed">
              Your streak resets to zero. Mewstro doesn&apos;t guilt
              you about it, the cat just falls asleep until you come
              back. When you do, you start building again from day one.
              If you genuinely did practise but forgot to log it, you
              can add a manual entry for a past date to save your
              streak.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-[#5A4E42] text-sm leading-relaxed">
              Hit certain milestones and you&apos;ll unlock streak
              badges at 3 days, 7 days, 14 days, 30 days, and beyond.
              These show up in your Achievements and Mewstro celebrates
              each one. They&apos;re yours to keep even if your streak
              breaks later on.
            </p>
          ...
          <section>
            ...
            <ul className="text-[#5A4E42] text-sm leading-relaxed list-disc list-inside space-y-2 ml-1">
              ...
              <li>Even a short session counts, five minutes of scales is better than nothing</li>
